...
public class ShopServiceImpl implements ITShopService
{
     ...
     */
    @Override
    public List<TShop> getSuggestShopAll(TShop tShop) {
        return tShopMapper.getSuggestShopAll(tShop);
    }
     ...
     */
    @Override
    public List<TShop> getNameShop(TShop tShop) {
        return tShopMapper.getNameShop(tShop);
    }
}
