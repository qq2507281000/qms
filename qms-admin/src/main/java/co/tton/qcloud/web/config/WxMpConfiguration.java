...
import co.tton.qcloud.web.controller.wp.handler.*;
...
public class WxMpConfiguration {
    ...
    public WxMpService wxMpService() {
        ...
        final List<WxMpProperties.Config> configs = this.properties.getConfigs();

        if (configs == null) {
            throw new RuntimeException("未能加载微信公众平台配置信息。");
        }
